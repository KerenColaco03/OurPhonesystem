...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnContinueShopping" runat="server" style="z-index: 1; left: 65px; top: 469px; position: absolute; height: 26px; width: 113px; right: 1115px;" Text="Cancel" OnClick="btnContinueShopping_Click" />
