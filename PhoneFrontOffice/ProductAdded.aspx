...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:RadioButton ID="rb64gb" runat="server" style="z-index: 1; left: 131px; top: 164px; position: absolute; right: 1274px" Text="64gb" />
            <asp:RadioButton ID="rb128gb" runat="server" style="z-index: 1; left: 204px; top: 163px; position: absolute" Text="128gb" />
